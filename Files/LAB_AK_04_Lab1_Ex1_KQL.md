...
```
- Of course wildcards are also available
```KQL
Perf
...
## How to use the Summarize Operator
...
```
# Scalar Operators for advanced logic like if then style processing and functions
